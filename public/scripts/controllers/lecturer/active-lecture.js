            ...
            var tabs = [
                {
                    ...
                    title: 'Інформація',
                    icon: 'fa-info-circle',
                    templateUrl: '/client/views/controllers/lecturer/active-lecture/tabs/info-tab-view.html',
                    isActive: false
                },
                {
                    id: 'survey',
                    title: 'Опитування',
                    icon: 'fa-pie-chart',
                    templateUrl: '/client/views/controllers/lecturer/active-lecture/tabs/survey-tab-view.html',
                    isActive: true
                },
                {
                    id: 'activity',
                    title: 'Активність',
                    icon: 'fa-bolt',
                    templateUrl: '/client/views/controllers/lecturer/active-lecture/tabs/activity-tab-view.html',
                    isActive: false
                },
                {
                    id: 'questions',
                    ...
                    templateUrl: '/client/views/controllers/lecturer/active-lecture/tabs/teacher-questions-tab-view.html',
                    isActive: false
                }
            ];
