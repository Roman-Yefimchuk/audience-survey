function loadOEmbedData (url) {
    ...
    return new (function (url) {
        ...
        var def = $.Deferred();
        this.url = url;
        var extend = this.extend = function extend (target) {
        ...
        var randomstring = this.randomstring = function (target) {
            for (var i = 1; i < arguments.length; i++) {
                var source = arguments[i];
...
// serialize payload and append it to the URL for GET requests
        ...
        var providers = this.providers = (function () {
        ...
        ;(function Oembed() {
            ...
            this.embedCode = function (externalUrl, embedProvider) {
                var self = this;
            ...
            this.getPhotoCode = function (url, oembedData) {
                var html;
            ...
            this.getRichCode = function (url, oembedData) {
                return oembedData.html;
            };

            this.getGenericCode = function (url, oembedData) {
            ...
            this.getOEmbedProvider = function (url) {
            ...
            this.getRequestUrl = function (provider, externalUrl) {
            ...
            this.getNormalizedParams = function (params) {
            ...
            this.success = function (oembedData, externalUrl) {
            ...
            this.error = function (oembedData) {
